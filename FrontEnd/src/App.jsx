...
function App() {
  ...
  async function updateData(updateFields = {}) {
    try {
      await axios.post("http://localhost:8000/update", updateFields);
    } catch (error) {
    ...
    <div>
      ...
      <section>
        ...
        <div className="buttons">
          ...
          <button onClick={fencingbtn}>
            {fencingValue ? "Turn OFF" : "Turn ON"}
          </button>
        </div>
        <div className="buttons">
          <p>Soil Moisture</p>
        ...
        <div className="buttons">
          ...
          <img
            src={motor}
            alt=""
            style={{ transform: `rotate(${fieldRotationAngle}deg)` }}
          />
          <button className="status" onClick={toggleFieldMotor}>
            {fieldMotorStatus ? "Stop" : "Start"}
          </button>
        </div>
        <div className="buttons">
          <p>Water Level</p>
        ...
        <div className="buttons">
          ...
          <img
            src={motor}
            alt=""
            style={{ transform: `rotate(${waterTankRotationAngle}deg)` }}
          />
          <button onClick={toggleWaterTankMotor}>
            {waterTankMotorStatus ? "Stop" : "Start"}
          </button>
        </div>
      </section>
    </div>
